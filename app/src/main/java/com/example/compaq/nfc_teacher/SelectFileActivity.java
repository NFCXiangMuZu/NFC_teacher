...
import com.example.compaq.nfc_teacher.MainActivity;
...
public class SelectFileActivity extends Activity {
	...
	private OnClickListener mEnsureBtnClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			intent.putExtra(MainActivity.SEND_FILE_NAME, file.getAbsolutePath());
			SelectFileActivity.this.setResult(MainActivity.RESULT_CODE, intent);
			SelectFileActivity.this.finish();
		}
	};
